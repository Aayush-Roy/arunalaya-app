...
//     {(props) => <SignupScreen {...props} isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} />}
//   </Tab.Screen>
// )}
//       </Tab.Navigator> 
...
export default function BottomTabNavigator({ setIsLoggedIn }) {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#141413' }}>
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarIcon: ({ color, size, focused }) => {
            ...
            else if (route.name === 'Offers') iconName = focused ? 'flame' : 'flame-outline';
